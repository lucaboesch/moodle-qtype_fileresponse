 ...
 *
 * Contains HTML class for a fileresponsessimplifiedfilemanager form element
 * 
 * @package    qtype
...
//require_once('fileresponsesimplifiedfilepicker.php');
...
class MoodleQuickForm_fileresponsesimplifiedfilemanager extends HTML_QuickForm_element {
    ...
    /**
     * Sets help button for fileresponsesimplifiedfilemanager
     *
