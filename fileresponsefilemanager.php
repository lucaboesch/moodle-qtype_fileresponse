...
/**
 * File response simplified file manager form element
 *
 * File response simplified file Manager lets user to upload/manage multiple files
 * @package   core_form
 * @category  form
...
class MoodleQuickForm_fileresponsefilemanager extends HTML_QuickForm_element {
    ...
    /**
     * Sets help button for fileresponsefilemanager
     *
...
//        require_once("$CFG->dirroot/repository/lib.php");
        ...
        $html = $this->_getTabs();
        $frsfm = new form_fileresponsefilemanager($options);
...
<div id="fileresponsefilemanager-'.$client_id.'" class="filemanager fm-loading">
    <div class="fp-restrictions">
        '.$restrictions.'
        <div class="dndupload-message"> - '.$strdndenabled.' </div>
    </div>
    <div class="fp-navbar">
        <div class="filemanager-toolbar">
            <div class="fp-toolbar">
                ...
                <div class="{!}fp-btn-download"><!--<a href="#"><img src="'.$this->pix_url('a/download_all').'" /> '.$strdownload.'</a>--></div> <!-- don\'t download fix -->
            </div>
