...
/**
 * File response file manager class.
 *
 * @package    qtype
...
class MoodleQuickForm_fileresponsefilemanager extends HTML_QuickForm_element {
    ...
    function toHtml() {
        ...
        $html = $this->_getTabs();
        $html .= form_fileresponsefilemanager_render($options);
...
function form_fileresponsefilemanager_render($options) {
    ...
    $html .= <<<FMHTML
<div class="filemanager-loading mdl-align" id='fileresponsefilemanager-loading-{$client_id}'>
$icon_progress
</div>
<div id="fileresponsefilemanager-wrapper-{$client_id}" style="display:none">
    ...
    <div class="filemanager-container" id="fileresponsefilemanager-{$client_id}">
...
FMHTML;
    ...
    $PAGE->requires->js_init_call('M.form_fileresponsefilemanager.init', array($options), true, $module);
