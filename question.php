...
// class qtype_fileresponse_question extends question_definition implements question_manually_gradable {
            ...
            if (array_key_exists('attachments', $response)) {
                ...
                if ((get_class($response['attachments'])) == 'question_file_saver') {
                    ...
                    if ($this->get_question_file_saver_value($response) == '') {
                        ...
                        $log .= 'value=' . $this->get_question_file_saver_value($response) . "\n";
...
//                    $log .= $i . "\n";
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload, $allowpickerplugins) {
        if ($component == 'question' && $filearea == 'response_attachments') {
            ...
            return parent::check_file_access($qa, $options, $component, $filearea, $args, $forcedownload, $allowpickerplugins);
        }
    }
